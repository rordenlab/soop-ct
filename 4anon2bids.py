...
def make_bids_boilerplate(bids_dir: Path):
    ...
    if not desc.exists():
        desc.write_text(json.dumps({
            "Name": "CT Stroke Imaging Dataset",
            "BIDSVersion": "1.8.0",
            "DatasetType": "raw",
            "Authors": ["Your Name"]
        }, indent=2))
